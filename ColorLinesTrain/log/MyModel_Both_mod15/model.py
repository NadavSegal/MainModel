...
class DentlyNet(nn.Module):
    def __init__(self, input_x=0, output_channels=14, is_training=True, batch_size=1):
        ...
        self.down0_conv = nn.Conv2d(3, 6, kernel_size=(9, 7), stride=(1, 1), padding=(4, 3)) #320  3X31X9X9 = 7533
        ...
        self.down3_conv = nn.Conv2d(12, 12, kernel_size=(5, 3), stride=(1, 1), padding=(2, 1)) #24X3X3X96 = 20736
        self.down3_conv_bn = nn.BatchNorm2d(12, track_running_stats=False, momentum=0.5)

        self.down4_conv = nn.Conv2d(12, 12, kernel_size=(5, 3), stride=(1, 1), padding=(2, 1)) #96X1X1X24 = 2304
        self.down4_conv_bn = nn.BatchNorm2d(12, track_running_stats=False, momentum=0.5)

        self.down5_conv = nn.Conv2d(12, 14, kernel_size=(5, 3), stride=(1, 1), padding=(2, 1)) #24X7X5X9 = 7560
        self.down5_conv_bn = nn.BatchNorm2d(14, track_running_stats=False, momentum=0.5)

        self.down6_conv = nn.Conv2d(14, 14, kernel_size=(5, 3), stride=(1, 1), padding=(2, 1)) #24X7X5X9 = 7560
