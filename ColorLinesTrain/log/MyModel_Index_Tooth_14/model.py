...
class DentlyNet(nn.Module):
    def __init__(self, input_x=0, output_channels=25, is_training=True, batch_size=1):
        ...
        self.down1_convSkel = nn.Conv2d(7, 7, kernel_size=(31, 5), stride=(1, 1), padding=(15, 2))
        self.down1_conv_bnSkel = nn.BatchNorm2d(7, track_running_stats=False, momentum=0.5)

        self.down2_convSkel = nn.Conv2d(7, 1, kernel_size=(31, 5), stride=(1, 1), padding=(15, 2))
