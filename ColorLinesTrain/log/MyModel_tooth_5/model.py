...
class DentlyNet(nn.Module):
    def __init__(self, input_x=0, output_channels=49+3, is_training=True, batch_size=1):
        ...
        self.down0_convNEW = nn.Conv2d(3, 14, kernel_size=(9, 3), stride=(1, 1), padding=(4, 1))
        self.down0_conv_bnNEW = nn.BatchNorm2d(14, track_running_stats=False, momentum=0.5)
        self.down1_convNEW = nn.Conv2d(14, 4, kernel_size=(9, 9), stride=(1, 1), padding=(4, 4))
        self.down1_conv_bnNEW = nn.BatchNorm2d(4, track_running_stats=False, momentum=0.5)
        self.down2_convNEW = nn.Conv2d(4, 1, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
