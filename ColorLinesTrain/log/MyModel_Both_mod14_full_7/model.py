...
class DentlyNet(nn.Module):
    def __init__(self, input_x=0, output_channels=28, is_training=True, batch_size=1):
        ...
        self.down2_conv = nn.Conv2d(28, 28, kernel_size=(25, 21), stride=(1, 1), padding=(12, 10))  # 24X31X9X24 = 160704
        self.down2_conv_bn = nn.BatchNorm2d(28, track_running_stats=False)

        self.down3_conv = nn.Conv2d(28, 28, kernel_size=(25, 21), stride=(1, 1), padding=(12, 10))  # 24X31X9X24 = 160704
        self.down3_conv_bn = nn.BatchNorm2d(28, track_running_stats=False)

        self.down6_conv = nn.Conv2d(28, 28, kernel_size=(25, 21), stride=(1, 1), padding=(12, 10))  # 24X3X3X96 = 20736
