...
class DentlyNet(nn.Module):
    def __init__(self, input_x=0, output_channels=14, is_training=True, batch_size=1):
        ...
        self.down1_conv = nn.Conv2d(3, 14, kernel_size=(11, 9), stride=(1, 1), padding=(5, 4))  # 320 9X7X5X24 = 7560
        ...
        self.down2_conv = nn.Conv2d(14, 14, kernel_size=(7, 5), stride=(1, 1), padding=(3, 2))  # 24X31X9X24 = 160704
        self.down2_conv_bn = nn.BatchNorm2d(14, track_running_stats=False, momentum=0.1)

        self.down3_conv = nn.Conv2d(14, 28, kernel_size=(5, 5), stride=(1, 1), padding=(2, 2))  # 24X31X9X24 = 160704
        self.down3_conv_bn = nn.BatchNorm2d(28, track_running_stats=False, momentum=0.1)

        self.down4_conv = nn.Conv2d(28, 56, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))  # 24X31X9X24 = 160704
        self.down4_conv_bn = nn.BatchNorm2d(56, track_running_stats=False, momentum=0.1)

        self.down4_1_conv = nn.Conv2d(56, 56, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))  # 24X31X9X24 = 160704
        self.down4_1_conv_bn = nn.BatchNorm2d(56, track_running_stats=False, momentum=0.1)

        self.down4_2_conv = nn.Conv2d(56, 56, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))  # 24X31X9X24 = 160704
        self.down4_2_conv_bn = nn.BatchNorm2d(56, track_running_stats=False, momentum=0.1)

        self.down4_3_conv = nn.Conv2d(56, 56, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))  # 24X31X9X24 = 160704
        self.down4_3_conv_bn = nn.BatchNorm2d(56, track_running_stats=False, momentum=0.1)

        self.down4_4_conv = nn.Conv2d(56, 56, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))  # 24X31X9X24 = 160704
        self.down4_4_conv_bn = nn.BatchNorm2d(56, track_running_stats=False, momentum=0.1)

        self.down5_conv = nn.Conv2d(56, 28, kernel_size=(5, 5), stride=(1, 1), padding=(2, 2))  # 24X31X9X24 = 160704
        self.down5_conv_bn = nn.BatchNorm2d(28, track_running_stats=False, momentum=0.1)

        self.down6_conv = nn.Conv2d(28, 14, kernel_size=(7, 5), stride=(1, 1), padding=(3, 2))  # 24X3X3X96 = 20736
        self.down6_conv_bn = nn.BatchNorm2d(14, track_running_stats=False, momentum=0.1)


        self.Unmp2d1 = torch.nn.MaxUnpool2d(kernel_size=(4, 4), stride=(4, 4), padding=(0, 0))

        self.down7_conv = nn.Conv2d(17, 14, kernel_size=(5, 3), stride=(1, 1), padding=(2, 1))  # 320 #24X7X5X9 = 7560
        self.down7_conv_bn = nn.BatchNorm2d(14, track_running_stats=False, momentum=0.1)
    ...
    def forward(self, x=torch.rand(1, 3, 640, 640), requires_grad=True):
        ...
        x_ind320 = self.down4_1_conv(x_ind320)
        x_ind320 = self.down4_1_conv_bn(x_ind320)
        x_ind320 = F.leaky_relu(x_ind320)

        x_ind320 = self.down4_2_conv(x_ind320)
        x_ind320 = self.down4_2_conv_bn(x_ind320)
        x_ind320 = F.leaky_relu(x_ind320)

        x_ind320 = self.down4_3_conv(x_ind320)
        x_ind320 = self.down4_3_conv_bn(x_ind320)
        x_ind320 = F.leaky_relu(x_ind320)

        x_ind320 = self.down4_4_conv(x_ind320)
        x_ind320 = self.down4_4_conv_bn(x_ind320)
        x_ind320 = F.leaky_relu(x_ind320)

        x_ind320 = self.down5_conv(x_ind320)
        x_ind320 = self.down5_conv_bn(x_ind320)
        x_ind320 = F.leaky_relu(x_ind320)
