...
class DentlyNet(nn.Module):
    def __init__(self, input_x=0, output_channels=14, is_training=True, batch_size=1):
        ...
        self.down1_conv = nn.Conv2d(4, 4, kernel_size=(21, 9), stride=(1, 1), padding=(10, 4))  # 320 9X7X5X24 = 7560
        self.down1_conv_bn = nn.BatchNorm2d(4, track_running_stats=False, momentum=0.1)

        self.down2_conv = nn.Conv2d(4, 4, kernel_size=(21, 9), stride=(1, 1), padding=(10, 4))  # 24X31X9X24 = 160704
        self.down2_conv_bn = nn.BatchNorm2d(4, track_running_stats=False, momentum=0.1)

        self.down3_conv = nn.Conv2d(4, 4, kernel_size=(15, 7), stride=(1, 1), padding=(7, 3))  # 24X3X3X96 = 20736
        self.down3_conv_bn = nn.BatchNorm2d(4, track_running_stats=False, momentum=0.1)

        self.down4_conv = nn.Conv2d(4, 4, kernel_size=(15, 7), stride=(1, 1), padding=(7, 3))  # 96X1X1X24 = 2304
        self.down4_conv_bn = nn.BatchNorm2d(4, track_running_stats=False, momentum=0.1)

        self.down5_conv = nn.Conv2d(4, 4, kernel_size=(15, 7), stride=(1, 1), padding=(7, 3))  # 24X7X5X9 = 7560
        self.down5_conv_bn = nn.BatchNorm2d(4, track_running_stats=False, momentum=0.1)

        #self.down6_conv = nn.Conv2d(4, 4, kernel_size=(15, 7), stride=(1, 1), padding=(7, 3))  # 80 #24X7X5X9 = 7560
        #self.down6_conv_bn = nn.BatchNorm2d(4, track_running_stats=False, momentum=0.1)

        self.down7_conv = nn.Conv2d(4, 14, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))  # 160 #24X7X5X9 = 7560
        self.down7_conv_bn = nn.BatchNorm2d(14, track_running_stats=False, momentum=0.1)

        self.down8_conv = nn.Conv2d(14, 14, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))  # 320 #24X7X5X9 = 7560
