...
class DentlyNet(nn.Module):
    def __init__(self, input_x=0, output_channels=49+3, is_training=True, batch_size=1):
        ...
        self.down0_conv = nn.Conv2d(3, 9, kernel_size=(3, 5), stride=(1, 1), padding=(1, 2))
        self.down0_conv_bn = nn.BatchNorm2d(9, track_running_stats=False, momentum=0.5)

        self.down1_conv = nn.Conv2d(9, 24, kernel_size=(5, 7), stride=(1, 1), padding=(2, 3))
        self.down1_conv_bn = nn.BatchNorm2d(24, track_running_stats=False, momentum=0.5)

        self.down2_conv = nn.Conv2d(24, 48, kernel_size=(3, 9), stride=(1, 1), padding=(1, 4))
        self.down2_conv_bn = nn.BatchNorm2d(48, track_running_stats=False, momentum=0.5)

        self.down3_conv = nn.Conv2d(48, 256, kernel_size=(5, 9), stride=(1, 1), padding=(2, 4))
        self.down3_conv_bn = nn.BatchNorm2d(256, track_running_stats=False, momentum=0.5)

        self.down5_conv = nn.Conv2d(256, 24, kernel_size=(5, 9), stride=(1, 1), padding=(2, 4))
        self.down5_conv_bn = nn.BatchNorm2d(24, track_running_stats=False, momentum=0.5)
        ...
        self.upSample10 = nn.Upsample(scale_factor=10, mode='bilinear', align_corners=False)
