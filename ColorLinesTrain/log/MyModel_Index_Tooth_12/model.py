...
class DentlyNet(nn.Module):
    def __init__(self, input_x=0, output_channels=49+3, is_training=True, batch_size=1):
        ...
        self.down0_conv = nn.Conv2d(3, 9, kernel_size=(31, 9), stride=(1, 1), padding=(15, 4)) #320  3X31X9X9 = 7533
        ...
        self.down3_conv = nn.Conv2d(9, 14, kernel_size=(5, 3), stride=(1, 1), padding=(2, 1)) #320 9*5*3*14 = 1890
        self.down3_conv_bn = nn.BatchNorm2d(14, track_running_stats=False, momentum=0.5)

        self.down5_conv = nn.Conv2d(14, 14, kernel_size=(5, 3), stride=(1, 1), padding=(2, 1)) # 14*5*3*14 = 2940
