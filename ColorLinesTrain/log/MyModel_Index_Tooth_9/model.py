...
class DentlyNet(nn.Module):
    def __init__(self, input_x=0, output_channels=49+3, is_training=True, batch_size=1):
        ...
        self.down2_conv = nn.Conv2d(24, 48, kernel_size=(7, 5), stride=(1, 1), padding=(1, 4))
        self.down2_conv_bn = nn.BatchNorm2d(48, track_running_stats=False, momentum=0.5)


        self.Unmp2d = torch.nn.MaxUnpool2d(kernel_size=(2, 2), stride=(2, 2), padding=(0, 0))


        self.down3_conv = nn.Conv2d(48, 24, kernel_size=(7, 5), stride=(1, 1), padding=(1, 4)) #320
        self.down3_conv_bn = nn.BatchNorm2d(24, track_running_stats=False, momentum=0.5)

        self.down5_conv = nn.Conv2d(24, 14, kernel_size=(5, 3), stride=(1, 1), padding=(2, 4))
    ...
    def forward(self, x=torch.rand(1, 3, 640, 640), requires_grad=True):
        ...
        x8_1, index = self.mp2dNEW(x7)
        x8_2 = self.Unmp2dNEW(x8_1, index)
