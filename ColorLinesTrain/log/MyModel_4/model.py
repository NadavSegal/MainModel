...
class DentlyNet(nn.Module):
    def __init__(self, input_x=0, output_channels=28, is_training=True, batch_size=1):
        ...
        self.down2_conv = nn.Conv2d(28, 28, kernel_size=(5, 3), stride=(1, 1), padding=(2, 1))  # 24X31X9X24 = 160704
        self.down2_conv_bn = nn.BatchNorm2d(28, track_running_stats=False, momentum = 0.5)

        self.down3_conv = nn.Conv2d(28, 28, kernel_size=(5, 3), stride=(1, 1), padding=(2, 1))  # 24X31X9X24 = 160704
        self.down3_conv_bn = nn.BatchNorm2d(28, track_running_stats=False, momentum = 0.5)
        
        self.down3b_conv = nn.Conv2d(28, 28, kernel_size=(5, 3), stride=(1, 1), padding=(2, 1))  # 24X31X9X24 = 160704
        self.down3b_conv_bn = nn.BatchNorm2d(28, track_running_stats=False, momentum = 0.5)        
        
        self.down3c_conv = nn.Conv2d(28, 28, kernel_size=(5, 3), stride=(1, 1), padding=(2, 1))  # 24X31X9X24 = 160704
        self.down3c_conv_bn = nn.BatchNorm2d(28, track_running_stats=False, momentum = 0.5)        

        self.down3d_conv = nn.Conv2d(28, 28, kernel_size=(5, 3), stride=(1, 1), padding=(2, 1))  # 24X31X9X24 = 160704
        self.down3d_conv_bn = nn.BatchNorm2d(28, track_running_stats=False, momentum = 0.5)        

        self.down3e_conv = nn.Conv2d(28, 28, kernel_size=(5, 3), stride=(1, 1), padding=(2, 1))  # 24X31X9X24 = 160704
