...
class DentlyNet(nn.Module):
    def __init__(self, input_x=0, output_channels=49+3, is_training=True, batch_size=1):
        ...
        self.down0_convNEW = nn.Conv2d(3, 7, kernel_size=(31, 5), stride=(1, 1), padding=(15, 2))
        self.down0_conv_bnNEW = nn.BatchNorm2d(7, track_running_stats=False, momentum=0.5)
        self.down1_convNEW = nn.Conv2d(7, 7, kernel_size=(31, 5), stride=(1, 1), padding=(15, 2))
        self.down1_conv_bnNEW = nn.BatchNorm2d(7, track_running_stats=False, momentum=0.5)
        self.down2_convNEW = nn.Conv2d(7, 1, kernel_size=(31, 5), stride=(1, 1), padding=(15, 2))
        ...
        self.mp2dNEW2 = torch.nn.MaxPool2d(kernel_size=(40, 1), stride=(40, 1), padding=(20, 0), return_indices=True)
        self.Unmp2dNEW2 = torch.nn.MaxUnpool2d(kernel_size=(40, 1), stride=(40, 1), padding=(20, 0))
    ...
    def forward(self, x=torch.rand(1, 3, 640, 640), requires_grad=True):
        ...
        x9_1, index = self.mp2dNEW2(x7)
        x9_2 = self.Unmp2dNEW2(x9_1, index)
