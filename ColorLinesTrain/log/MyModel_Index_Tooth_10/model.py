...
class DentlyNet(nn.Module):
    def __init__(self, input_x=0, output_channels=49+3, is_training=True, batch_size=1):
        ...
        self.down0_conv = nn.Conv2d(3, 9, kernel_size=(5, 3), stride=(1, 1), padding=(2, 1)) #320
        ...
        self.down2_conv = nn.Conv2d(24, 24, kernel_size=(7, 5), stride=(1, 1), padding=(3, 2))
    ...
    def forward(self, x=torch.rand(1, 3, 640, 640), requires_grad=True):
        ...
        return 0, indexing_pred, indexing_argmax
