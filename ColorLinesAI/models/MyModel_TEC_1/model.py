...
class DentlyNet(nn.Module):
    def __init__(self, input_x=0, output_channels=49+3, is_training=True, batch_size=1):
        ...
        self.down0_convNEW = nn.Conv2d(3, 7, kernel_size=(13, 3), stride=(1, 1), padding=(6, 1))
        self.down0_conv_bnNEW = nn.BatchNorm2d(7, track_running_stats=False, momentum=0.5)
        self.down1_convNEW = nn.Conv2d(7, 7, kernel_size=(13, 3), stride=(1, 1), padding=(6, 1))
        self.down1_conv_bnNEW = nn.BatchNorm2d(7, track_running_stats=False, momentum=0.5)
        self.down2_convNEW = nn.Conv2d(7, 1, kernel_size=(13, 3), stride=(1, 1), padding=(6, 1))
        self.mp2dNEW = torch.nn.MaxPool2d(kernel_size=(16, 1), stride=(16, 1), padding=(0, 0), return_indices=True)
        self.Unmp2dNEW = torch.nn.MaxUnpool2d(kernel_size=(16, 1), stride=(16, 1), padding=(0, 0))
