...
class eval_socket:
    def __init__(self, dict_path="./config_data/data_1280.json", mode='1280'):
    ...
    def listen_and_eval_slow(self): #slow/alon
        ...
        while True:
            ...
            unserialized_input = np.frombuffer(data, dtype=np.uint8).reshape(1280, 800, 3)
            st = time.time()
...
mainServer = eval_socket(dict_path="./config_data/data_1280.json", mode='1280')
