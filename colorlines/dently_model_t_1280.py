...
class DentlyNet(nn.Module):
    def __init__(self, input_x=0, output_channels=49+3, is_training=True, batch_size=1):
        ...
        self.down00_conv = nn.Conv2d(3, 16, kernel_size=(5,5), stride=(2, 2), padding=2)
        self.down00_conv_bn = nn.BatchNorm2d(16, track_running_stats=False, momentum=0.5)
        self.down000_conv = nn.Conv2d(3, 16, kernel_size=(1,1), stride=(2, 2))
        self.down000_conv_bn = nn.BatchNorm2d(16, track_running_stats=False, momentum=0.5)
        
        
        self.down1_conv = nn.Conv2d(48, 16, kernel_size=(3,3), stride=(2, 2), padding=1)
        ...
        self.upsample16_conv  = nn.Conv2d(64, 32, kernel_size=(self.ks, self.ks), stride=(1, 1), padding=1)
...
#        x = Variable(x_111, requires_grad=requires_grad).cuda()
        ...
        x_00 = torch.cat((x_00, x_000, x_0000), 1)
        ...
        try: 
            x = self.upsample1_ConvTranspose2d(x, output_size=(80, 80))
        except:
            print()
        ...
        x = self.upsample5_ConvTranspose2d(x, output_size=(160, 160))
        ...
        x = self.upsample10_ConvTranspose2d(x, output_size=(320, 320)) 
        ...
        x = self.upsample14_ConvTranspose2d(x, output_size=(640, 640)) 
        ...
        x = F.relu(self.upsample18_ConvTranspose2d(x, output_size=(1280, 1280)))
