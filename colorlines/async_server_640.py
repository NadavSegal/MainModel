...
class eval_socket:
    def __init__(self, dict_path="./config_data/data_640.json", mode='640'):
    ...
    def listen_and_eval_slow(self): #slow/alon
        ...
        while True:
            ...
            unserialized_input = np.frombuffer(data, dtype=np.uint8).reshape(640, 640, 3)
            st = time.time()
...
mainServer = eval_socket(dict_path="./config_data/data_640.json", mode='640')
